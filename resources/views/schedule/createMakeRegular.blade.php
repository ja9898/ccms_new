            ...
            <div class="row">
              <div class="col-md-12">
				...
				<div class="form-group">
					  ...
					  <div class="col-sm-6">
						<label for="paydate" class="control-label">M,T,W</label>
					  </div>      
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label">Agent Commision</label>
					<div class="col-sm-6">
						<select id="agent_id" name="agent_id" class="form-control select" style="width: 100%;">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<select id="teacher_id" name="teacher_id" class="form-control select" style="width: 100%;">
