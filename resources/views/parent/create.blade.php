            ...
            <div class="row">
              ...
              <div class="col-md-8">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="extId" name="extId" placeholder="Ext ID" value="{{ old('phonenumber') }}" autocomplete="off" require>
                    @if ($errors->has('extId'))
                          <span class="text-red">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <select name="user_type" class="form-control">
						...
						<option value="19" selected>Parent - 19</option>									
					  </select>
