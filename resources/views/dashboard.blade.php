 ...
 <div class="row">
      <div class="col-md-6">
         <div class="box box-success">
            ...
            <div class="box-body">
              <div class="chart">
                <canvas id="barChart1" style="height: 156px; width: 535px;" width="535" height="156"></canvas>
              </div>
            </div>
            <!-- /.box-body -->
        </div>
    ...
    <div class="col-md-6">
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Product in last 7 days</h3>
            ...
            <div class="box-body">
              <div class="chart">
                <canvas id="barChart2" style="height: 156px; width: 535px;" width="535" height="156"></canvas>
              </div>
            </div>
            <!-- /.box-body -->
        </div>
