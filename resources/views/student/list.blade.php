        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="{!! url('/student/create'); !!}" class="btn btn-info"><span class="fa fa-plus"></span> Add Student</a>
              ...
              <table id="example1" class="display responsive nowrap" style="width:100%">
                ...
                ?>
                  <tr>
					...
					<td><b>Students</b></td>
                    <td>
                      <a href="{!! url('/student/'.$x) !!}" class="btn btn-primary" title="View Detail"><i class="fa fa-eye"></i> </a>
					  <a class="btn btn-success" title="Edit"  href="{!! url('/student/'.$x.'/edit') !!}"><i class="fa fa-edit"></i> </a>
