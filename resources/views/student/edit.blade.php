...
.kv-reqd {
    ...
    <div class="box box-info">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Edit Student {{ $id }} </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="fname" name="fname" placeholder="First Name" autocomplete="off" value="Student" require >
                    @if ($errors->has('fname'))
                          <span class="text-red">
